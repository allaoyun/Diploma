<template>
  <div class="search-page">
    <div class="gradient-section">
      <h1 class="search-title">Заказать</h1>
    </div>
    <div class="section">
      ...
      <div class="checkout-card">
        <div class="header-checkout">
          <p class="checkout-title">Итого</p>
        </div>
        <div class="body-checkout">
          <p class="text-box">Доставка : ${{ getShipping }}</p>
          <p class="text-total">Итого ${{ cartCheckoutPrice }}</p>
        </div>
        <div class="footer-checkout" to="/checkout">
          <div class="checkout" @click.prevent="orderSuccess()">Заказать</div>
        </div>
      </div>
    </div>
  </div>
