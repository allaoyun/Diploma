<template>
  <div class="navbar" :class="{ change_color: scrollPosition > 200 }">
    <a class="left" href="https://ttit.rtyva.ru/">
      <p>@Альбина(40б)</p>
    </a>
    <div class="center">
      <div class="logo">Магазин игрушек</div>
      <div class="navlink">
        <router-link class="nav-page" to="/">Главная</router-link>
        <router-link class="nav-page" to="/women">Девочкам</router-link>
        <router-link class="nav-page" to="/men">Мальчикам</router-link>
        <router-link class="nav-page" to="/about">О нас</router-link>
      </div>
    </div>
    <div class="right">
      <div class="search">
